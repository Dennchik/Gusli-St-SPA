...
export const Services = () => {
	...
	return (<Element className='services key-object' name='services'>
										...
										<svg viewBox='0 0 250 40'>
											<defs>
												<linearGradient id='grad'
													...
													<stop offset='0%'
																style={{
																	stopColor: 'rgb(57, 255, 20)', stopOpacity: 1
																}}/>
													<stop offset='100%'
																style={{
																	stopColor: 'rgb(204, 255, 0)', stopOpacity: 1
																}}/>
												</linearGradient>
											</defs>
											<g fill='none'
										...
										<picture>
											{isWebpSupported() ?
												<img src={'@@webRoot/img/main/body/img_2.webp'}
														 alt='image-2'/> :
												<img src={'@@webRoot/img/main/body/img_2.png'}
														 alt='image-2'/>}
										</picture>
										<picture>
											{isWebpSupported() ?
										...
										<picture>
											{isWebpSupported() ?
												<img src={'@@webRoot/img/main/body/img_3.webp'}
														 alt='image-3'/> :
												<img src={'@@webRoot/img/main/body/img_3.png'}
														 alt='image-3'/>}
										</picture>
										<picture>
											{isWebpSupported() ?
										...
										<picture>
											{isWebpSupported() ?
												<img src={'@@webRoot/img/main/body/img_4.webp'}
														 alt='image-4'/> :
												<img src={'@@webRoot/img/main/body/img_4.png'}
														 alt='image-4'/>}
										</picture>
										<picture>
											{isWebpSupported() ?
										...
										<picture>
											{isWebpSupported() ?
												<img src={'@@webRoot/img/main/body/img_5.webp'}
														 alt='image-5'/> :
												<img src={'@@webRoot/img/main/body/img_5.png'}
														 alt='image-5'/>}
										</picture>
										<picture>
											{isWebpSupported() ?
