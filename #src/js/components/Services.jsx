			...
			<div className='material-parallax parallax'>
				<div className='parallax__image'>
					<picture>{isWebpSupported() ? (
						<source srcSet={'@@webRoot/img/main/body/parallax_bg.webp'}
						        type='image/webp'/>
					) : null}
						<img src={'@@webRoot/img/main/body/parallax_bg.png '}
						     alt='bg-image'/>
					</picture>
				</div>
			</div>
